...
uses
  ualtclientes, utilitarios, queries, ubusca, uselecionar,
  uprepararelatorio, ualttelefones;

{ TfrmClientes }

procedure TfrmClientes.actInserirRegistroExecute(Sender: TObject);
begin
  with TfrmAltClientes.create(self) do
  try
    modoEdicao := false;
...
procedure TfrmClientes.actOrdenarExecute(Sender: TObject);
begin
  bufCadastros.IndexFieldNames:='nome';
end;

procedure TfrmClientes.actRelatoriosExecute(Sender: TObject);
begin
...
procedure TfrmClientes.actSelecionarExecute(Sender: TObject);
begin
  ...
  try
    ...
    begin
      ...
      qrConsulta.SQL.Text := (listarClientes + sqlComplemento);
...
procedure TfrmClientes.actBuscarExecute(Sender: TObject);
var
...
procedure TfrmClientes.actDeletarExecute(Sender: TObject);
var
  qr: TZQuery;
begin
