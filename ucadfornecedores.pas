...
procedure TfrmFornecedores.actInserirRegistroExecute(Sender: TObject);
begin
...
procedure TfrmFornecedores.actOrdenarExecute(Sender: TObject);
begin
  bufCadastros.IndexFieldNames:='nome';
end;

procedure TfrmFornecedores.actRelatoriosExecute(Sender: TObject);
begin
...
procedure TfrmFornecedores.actSelecionarExecute(Sender: TObject);
begin
...
procedure TfrmFornecedores.actAtualizarExecute(Sender: TObject);
begin
  qrConsulta.SQL.Text:= listarFornecedores;
  Listar;
end;

procedure TfrmFornecedores.actBuscarExecute(Sender: TObject);
var
...
procedure TfrmFornecedores.actDeletarExecute(Sender: TObject);
var
  qr: TZQuery;
begin
